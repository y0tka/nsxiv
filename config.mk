...
#PREFIX for install
    PREFIX = / usr / local MANPREFIX = $(PREFIX) / share / man EGPREFIX =
                                           $(PREFIX) / share / doc / nsxiv /
                                           examples
...
#optional dependencies, see README for more info
        HAVE_LIBFONTS = $(OPT_DEP_DEFAULT) HAVE_LIBEXIF = $(OPT_DEP_DEFAULT)

#unused if imlib2 version is 1.8.0 or higher.
#these options will be removed eventually.
            HAVE_LIBGIF = $(OPT_DEP_DEFAULT) HAVE_LIBWEBP = $(OPT_DEP_DEFAULT)
...
#icons that will be installed via `make icon`
                             ICONS =
                             16x16.png 32x32.png 48x48.png 64x64.png 128x128.png
...
#CPPFLAGS = -I / usr / X11R6 / include -                                       \
            I / usr / local / include $(inc_fonts_bsd_$(HAVE_LIBFONTS))
#LDLIBS = -L / usr / X11R6 / lib -                                             \
          L / usr / local / lib $(lib_fonts_bsd_$(HAVE_LIBFONTS))
